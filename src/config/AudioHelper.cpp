...
string AudioHelper::getMusicName(int id) {
    switch (id) {
        case 0 : return "data/musics/Titre.ogg";
        case 1 : return "data/musics/Fee.ogg";
        case 2 : return "data/musics/Mort.ogg";
        case 3 : return "data/musics/Plage.ogg";
        case 4 : return "data/musics/Jungle.ogg";
        case 5 : return "data/musics/Coquillages.ogg";
        case 6 : return "data/musics/Opening.ogg";
        case 7 : return "data/musics/Lac.ogg";
        case 8 : return "data/musics/Plaine.ogg";
        case 9 : return "data/musics/Falaises.ogg";
        case 10 : return "data/musics/Gemmes.ogg";
        case 11 : return "data/musics/Marais.ogg";
        case 12 : return "data/musics/Fontaine.ogg";
        case 13 : return "data/musics/Canyon.ogg";
        case 14 : return "data/musics/Desert.ogg";
        case 15 : return "data/musics/VillageO.ogg";
        case 16 : return "data/musics/Cimetiere.ogg";
        case 17 : return "data/musics/Mont.ogg";
        case 18 : return "data/musics/Cave.ogg";
        case 19 : return "data/musics/Boss.ogg";
        case 20 : return "data/musics/Epee.ogg";
        case 21 : return "data/musics/Magasin.ogg";
        case 22 : return "data/musics/Jeu.ogg";
        case 23 : return "data/musics/Maison.ogg";
        case 24 : return "data/musics/Maire.ogg";
        case 25 : return "data/musics/Bar.ogg";
        case 26 : return "data/musics/Colisee.ogg";
        case 27 : return "data/musics/Sorciere.ogg";
        case 28 : return "data/musics/DJungle.ogg";
        case 29 : return "data/musics/DTerre.ogg";
        case 30 : return "data/musics/DPyramide.ogg";
        case 31 : return "data/musics/DEau.ogg";
        case 32 : return "data/musics/DFeu.ogg";
        case 33 : return "data/musics/DOmbre.ogg";
        case 34 : return "data/musics/DGlace.ogg";
        case 35 : return "data/musics/DSecret.ogg";
        case 36 : return "data/musics/DFinal.ogg";
        case 37 : return "data/musics/DFinal2.ogg";
        case 38 : return "data/musics/BossF.ogg";
        case 39 : return "data/musics/End.ogg";
        default : return "";
    }
}
